...
$.ajax({
	...
	data: {
		key: '4N2BZ-GCTK3-UQE3Z-OKH62-OJRSH-5GFFA', // 这里要写你的KEY!!!
		output: 'jsonp',
	},
	dataType: 'jsonp',
...
function showWelcome() {
		...
		case '中国':
			...
			switch (ipLoacation.result.ad_info.province) {
				...
				case '湖北省':
					switch (ipLoacation.result.ad_info.city) {
						case '武汉市':
							posdesc = '来碗传说中的武汉热干面吧!'
							break
						case '襄阳市':
							posdesc = '城南花海，遇见美好，感触自然！'
							break
						case '宜昌市':
							posdesc = '三峡大坝，旅游胜地!'
							break
	...
	try {
		...
		document.getElementById(
			'welcome-info'
		).innerHTML = `<b><center>🎉 欢迎信息 🎉</center>欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴，${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里，${posdesc}</b>`
	} catch (err) {
...
function getWeibo() {
  // 这里要写上你的API!!!
	fetch('https://weibo.aleliauk.top/api')
		.then((data) => data.json())
		.then((data) => {
			let html =
...
function createtime1() {
	var grt = new Date('05/23/2022 00:00:00') //此处修改你的建站时间或者网站上线时间
...
function createtime() {
	...
	// 网站诞生时间
	var grt = new Date('05/23/2022 00:00:00')
	...
	;;;(currentTimeHtml =
		hnum < 18 && hnum >= 9
			? `<img class='boardsign' style='width: 140px' src='https://tuchuang.voooe.cn/images/2023/04/19/E-research.png' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">小破站已艰难运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
			: `<img class='boardsign' style='width: 140px' src='https://tuchuang.voooe.cn/images/2023/04/19/E-rest.png' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">小破站已艰难运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_01.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_01.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_69.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_69.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_80.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_80.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_108.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_108.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_126.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_126.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_39.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_39.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_92.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_92.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_114.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_114.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_124.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_124.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_149.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_149.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_154.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_154.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_187.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_187.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_189.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_189.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_191.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_191.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_198.webp)" class="imgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_191.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_33.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_33.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_34.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_34.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_78.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_78.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_85.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_85.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_100.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_100.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_107.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_107.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_111.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_111.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_128.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_128.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_130.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_130.webp)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://tuchuang.voooe.cn/images/2023/04/12/cover_195.webp)" class="pimgbox" onclick="changeBg('url(https://tuchuang.voooe.cn/images/2023/04/12/cover_195.webp)')"></a></div>
              </div>
            </details>
